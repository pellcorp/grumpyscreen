...
PrintPanel::PrintPanel(KWebSocketClient &websocket, std::mutex &lock, PrintStatusPanel &ps)
  ...
  , status_btn(file_view, &info_img, "Status", ButtonContainer::direct(&PrintPanel::_handle_status_btn, this))
  , print_btn(file_view, &print, "Print", ButtonContainer::direct(&PrintPanel::_handle_print_callback, this))
  , back_btn(file_view, &back, "Back", ButtonContainer::direct(&PrintPanel::_handle_back_btn, this))
  , root("", "", 0)
  , cur_dir(&root)
  , cur_file(NULL)
