  ...
  , chamber_sensor_key_(Config::get_instance()->get<std::string>("/ui/chamber_temp_sensor"))
{
  ...
  static lv_coord_t grid_main_row_dsc[] = {LV_GRID_FR(5), LV_GRID_FR(3), LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_size(pbar_cont, LV_PCT(100), scale_r(22));
  lv_obj_set_size(progress_bar, LV_PCT(100), LV_PCT(100));
  lv_bar_set_value(progress_bar, 0, LV_ANIM_OFF);

  lv_label_set_text(progress_label, "0%");
  lv_obj_set_style_text_font(progress_label, scale_font(14), 0);
