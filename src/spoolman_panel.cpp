...
SpoolmanPanel::SpoolmanPanel(KWebSocketClient &c, std::mutex &l)
  ...
  , reload_btn(controls, &refresh_img, "Reload", ButtonContainer::direct(&SpoolmanPanel::_handle_callback, this))
  , back_btn(controls, &back, "Back", ButtonContainer::direct(&SpoolmanPanel::_handle_callback, this))
  , active_id(-1)
