...
FineTunePanel::FineTunePanel(KWebSocketClient &websocket_client, std::mutex &l)
  ...
  , zreset_btn(panel_cont, &refresh_img, "Reset Z", ButtonContainer::direct(&FineTunePanel::_handle_zoffset, this))
  , zup_btn(panel_cont, &z_closer, "Z+", ButtonContainer::direct(&FineTunePanel::_handle_zoffset, this))
  , zdown_btn(panel_cont, &z_farther, "Z-", ButtonContainer::direct(&FineTunePanel::_handle_zoffset, this))
  , pareset_btn(panel_cont, &refresh_img, "Reset PA", ButtonContainer::direct(&FineTunePanel::_handle_pa, this))
  , paup_btn(panel_cont, &pa_plus_img, "PA+", ButtonContainer::direct(&FineTunePanel::_handle_pa, this))
  , padown_btn(panel_cont, &pa_minus_img, "PA-", ButtonContainer::direct(&FineTunePanel::_handle_pa, this))
  , speed_reset_btn(panel_cont, &refresh_img, "Speed Reset", ButtonContainer::direct(&FineTunePanel::_handle_speed, this))
  , speed_up_btn(panel_cont, &speed_up_img, "Speed+", ButtonContainer::direct(&FineTunePanel::_handle_speed, this))
  , speed_down_btn(panel_cont, &speed_down_img, "Speed-", ButtonContainer::direct(&FineTunePanel::_handle_speed, this))
  , flow_reset_btn(panel_cont, &refresh_img, "Flow Reset", ButtonContainer::direct(&FineTunePanel::_handle_flow, this))
  , flow_up_btn(panel_cont, &flow_up_img, "Flow+", ButtonContainer::direct(&FineTunePanel::_handle_flow, this))
  , flow_down_btn(panel_cont, &flow_down_img, "Flow-", ButtonContainer::direct(&FineTunePanel::_handle_flow, this))
  , back_btn(panel_cont, &back, "Back", ButtonContainer::direct(&FineTunePanel::_handle_callback, this))
